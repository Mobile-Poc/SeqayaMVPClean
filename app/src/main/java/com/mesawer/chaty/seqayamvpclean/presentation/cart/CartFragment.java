...
public class CartFragment extends BaseFragment implements CartContract.View, CartAdapter.TotalListener {
    ...
    @Override
    public void navigateToDeliveryTimeFragment() {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            navigateToDeliveryTimeFragment();
        }
    }
