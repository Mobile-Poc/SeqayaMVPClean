...
public class UseCaseHandler {
    ...
    private <V extends UseCase.ResponseValues> void notifyError(
            final UseCase.UseCaseCallback<V> useCaseCallback, String errMsg) {
        mUseCaseScheduler.onError(useCaseCallback, errMsg);
    }
    ...
    private static final class UiCallbackWrapper<V extends UseCase.ResponseValues> implements
        ...
        public void onError(String errMsg) {
            mUseCaseHandler.notifyError(mCallback, errMsg);
        }
    }
